...
import { GlareCard } from "./GlareCard.jsx"; // make sure this path is correct
    ...
    >
      <div className="container mx-auto px-6 py-20">
        ...
        <div className="mb-16 flex flex-col md:flex-row gap-4">
          ...
          <p
            className={`text-[1rem] max-w-md transition-colors duration-500 ${
              isDark ? "text-gray-300" : "text-gray-600"
            }`}
          >
            From bold branding to scroll-stopping graphics, we help your business
            stand out, stay memorable, and drive results.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-20">
          {services.map((service, index) => (
            <a href={service.link || "#"} rel="noopener noreferrer" key={index}>

            <GlareCard key={index} className="w-full h-full group ">
              <div
                className={`group relative p-6 rounded-2xl border transition-all duration-300 group-hover:bg-green-500 group-hover:text-black cursor-pointer ${
                  isDark
