...
export default function BlogCard({ blog }) {
  return (
    <motion.div
      className="flex flex-col overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm transition-all duration-300"
      ...
      <div className="flex flex-col flex-1 p-5">
        ...
        <div className="mt-auto pt-4 flex items-center justify-between">
          ...
          <Link
            ...
            className="text-sm font-medium text-green-600 underline hover:text-green-800 transition-colors"
          >
            Read More →
          </Link>
        </div>
